...
namespace PolymorphismInheritance
{
    ...
    class Program
    {
        static void main(string[] args)
        {
            ...
            connections.Add(new SqlConnection("SAMPLE CONNECTING SQL STRING"));
            connections.Add(new OracleConnection("SAMPLE CONNECTING ORACLE STRING"));

            //DbConnection dbConnection = new SqlConnection("Connecting String Sample");
            DbCommand command;

            foreach (var connection in connections)
            {
                command = new DbCommand(connection, "UPDATE COMMAND");
                command.Execute();
            }
     ...
     public class DbCommand 
    {
        ...
        string _command;
        public DbCommand(DbConnection connector, string instruction)
        {
            if (connector == null || string.IsNullOrEmpty(instruction))
                throw new ArgumentNullException("Connector/Command", "Connector/Command is null");
    ...
    public abstract class DbConnection
    {
        ...
        public DbConnection(string connectingString)
        {
            if (string.IsNullOrEmpty(connectingString))
                throw new ArgumentNullException("Connection String", "Connection String is Null.");
    ...
    public class SqlConnection : DbConnection
    {
        ...
        {
            Console.WriteLine("Opening Sql Connection using the following Connection String: " + ConnectingString);
        }
    }
    ...
    public class OracleConnection : DbConnection
    {
        ...
        public override void Open()
        {
            Console.WriteLine("Opening Oracle Connection using the following Connection String: " + ConnectingString);
        }
    }
}